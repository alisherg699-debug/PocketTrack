...
class _$ExpenseModelImpl implements _ExpenseModel {
  ...
  @override
  String toString() {
    return 'ExpenseModel(id: $id, title: $title, amount: $amount, category: $category, description: $description, date: $date, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _ExpenseModel implements ExpenseModel {
  const factory _ExpenseModel(
      ...
      @HiveField(7) required final DateTime updatedAt}) = _$ExpenseModelImpl;
