...
class _$AuthResultImpl implements _AuthResult {
  ...
  @override
  String toString() {
    return 'AuthResult(id: $id, username: $username, email: $email, firstName: $firstName, lastName: $lastName, gender: $gender, image: $image, accessToken: $accessToken, refreshToken: $refreshToken, phone: $phone, currency: $currency)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, username, email, firstName,
      lastName, gender, image, accessToken, refreshToken, phone, currency);
...
abstract class _AuthResult implements AuthResult {
  const factory _AuthResult(
      ...
      final String? phone,
      final String? currency}) = _$AuthResultImpl;
